-- Progresso das missões de selos para o profissional logado (lê streaks/transactions com SECURITY DEFINER).
...
REVOKE ALL ON FUNCTION public.get_my_seal_missions() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_my_seal_missions() TO authenticated;
